...
def test_handle_repos_routes_to_repo_handler():
    ...
    with (
        ...
        patch("git_mirror.__main__.validate_parse_args", return_value=("test_domain", 0)),
...
def test_validate_parse_args_reads_values_from_config():
    ...
    assert (domain, return_value) == ("https://ghe.example.com/api/v3", 0)
